...
<body class="bg-body text-body">
  ...
  <div class="container mt-5" style="max-width: 900px;">
    ...
    <form method="get" class="d-flex mb-4" role="search">
      ...
      <input type="text" name="search" id="searchInput" class="form-control me-2" placeholder="Search followers..."
          ...
          <div class="col text-center">
            <a href="/profile?id=<?= $f['user_id'] ?>" class="text-decoration-none follower-link">
              <div class="follower-card">
                <img src="/get_image.php?id=<?= $f['user_id'] ?>" alt="<?= htmlspecialchars($f['username']) ?>'s avatar"
